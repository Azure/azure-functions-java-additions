...
git clone https://github.com/Microsoft/azure-maven-plugins.git -b azure-functions-maven-plugin-1.16.0
...
Copy-Item -Path "./azure-functions-java-worker/annotationLib" -Destination "./azure-functions-java-worker/Azure.Functions.Cli/workers/java/" -Recurse
